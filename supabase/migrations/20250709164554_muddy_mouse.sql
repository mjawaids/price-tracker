/*
  # Create missing tables for price comparison app

  1. New Tables
    - `products` - Store product information with variants as JSONB
    - `stores` - Store information for physical and online stores  
    - `shopping_lists` - User shopping lists with items as JSONB
...
-- Drop existing policies if they exist and create new ones for products
...
-- Drop existing policies if they exist and create new ones for stores
...
-- Drop existing policies if they exist and create new ones for shopping_lists
